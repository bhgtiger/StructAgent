...
- **Verified 2026-09-07:** current links and additions checked against the Guide index; older cards retain their historical dataset context. Check `version_caveats.md` for v4/v5 differences. For repeated-target Workflows v1/v2, read `automated_workflow_tutorials.md`.

## Scenario map

| User situation / phenotype | Primary case-study pattern | Complementary refs |
|---|---|---|
| Unexpected species, bimodal scale distribution, multimodal sample | Complex I, EMPIAR-10927 | `06_abinitio.md`, `08_classification_3d.md` |
| Repeat-target GPCR or CAK automation | Workflows v1/v2 | `automated_workflow_tutorials.md` |
...
### Complex I — unexpected targets and discrete states (EMPIAR-10927)
Source: [Acetogenin-bound complex I case study](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/case-study-discrete-heterogeneity-in-a-sample-of-acetogenin-bound-complex-i-empiar-10927).

- **Trigger:** acceptable consensus map but bimodal particle scales, disappearing domains in 3DVA, or suspected co-purifying species.
- **Worked branch:** refine against a known volume → inspect scales → split with Subset Particles by Statistic → inspect both subsets and rejected particles in 2D. Low scale can mean another target, not just junk.
- **Discovery branch:** multiclass ab initio → heterogeneous refinement → refine each target separately. The study's exploratory example uses 14 classes, 18 Å initial resolution, Fourier radius step 0.005, minibatches 300→1000, and non-negativity off; these are empirical example settings, not defaults.
- **State separation:** compare 3DVA clusters, 3D Classification (v5 latent mixing), and ab initio/heterogeneous refinement. Re-refine classes and compare biological features, particle overlap, and assignment reproducibility. Similar FSC resolutions do not establish equivalent sorting or exact population fractions.
- **Load:** `particle_set_operations.md`, `06_abinitio.md`, `08_classification_3d.md`, `26_continuous_heterogeneity.md` as needed.

### Motor-bound nucleosome parts 1/2 — pseudosymmetry + low-population state separation
Official entries: [End-to-end processing of a motor-bound nucleosome part 1](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/case-study-end-to-end-and-exploratory-processing-of-a-motor-bound-nucleosome-empiar-10739); [Processing of a motor-bound nucleosome part 2](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/case-study-processing-of-a-novel-motor-bound-nucleosome-state-empiar-10739-part-2); EMPIAR-10739.
...
Official entry: [End-to-end processing of a ligand-bound GPCR](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/case-study-end-to-end-processing-of-a-ligand-bound-gpcr-empiar-10853); EMPIAR-10853.
...
Official entry: [DkTx-bound TRPV1](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/case-study-dktx-bound-trpv1-empiar-10059); EMPIAR-10059.
...
Official entry: [Pseudosymmetry in TRPV5 and Calmodulin](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/case-study-pseudosymmetry-in-trpv5-and-calmodulin-empiar-10256); EMPIAR-10256.
...
Official entry: [End-to-end processing of an inactive GPCR](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/case-study-end-to-end-processing-of-an-inactive-gpcr-empiar-10668); EMPIAR-10668.
...
Official entry: [End-to-end processing of encapsulated ferritin](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/case-study-end-to-end-processing-of-encapsulated-ferritin-empiar-10716); EMPIAR-10716.
...
Official entry: [Discrete and Continuous Heterogeneity in FaNaC1](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/case-study-discrete-and-continuous-heterogeneity-in-fanac1-empiar-11631-and-11632); EMPIAR-11631/11632.
...
Official entry: [Picking-induced Orientation Bias in HA Trimer](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/case-study-picking-induced-orientation-bias-in-ha-trimer-empiar-10096-and-10097); EMPIAR-10096/10097.
...
Official entry: [Yeast U4/U6.U5 tri-snRNP](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/case-study-yeast-u4-u6.u5-tri-snrnp); EMPIAR-10073.
...
Official entry: [Exploratory data processing by Oliver Clarke](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/case-study-exploratory-data-processing-by-oliver-clarke).
...
Official entry: [Tips for Membrane Protein Structures](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/tutorial-tips-for-membrane-protein-structures).
...
Official entry: [Common CryoSPARC Plots](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/tutorial-common-cryosparc-plots).
...
|---|---|---|
| [Tutorial: Negative Stain Data](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/negative-stain-data) | negative-stain import/preprocessing differs from standard cryo-EM SPA | `02_import.md`, `03_preprocessing.md` |
| [Tutorial: Phase Plate Data](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/phase-plate-data) | phase-plate data or CTF interpretation needs special care | `02_import.md`, `03_preprocessing.md`, `ctf_refinement_and_rbmc.md` |
| [Tutorial: EER File Support](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/tutorial-eer-file-support) | importing/processing EER movies | `02_import.md`, `03_preprocessing.md`, `version_caveats.md` |
| [Tutorial: EPU AFIS Beam Shift Import](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/tutorial-epu-afis-beam-shift-import) | EPU AFIS / beam-shift metadata import | `02_import.md`, `ctf_refinement_and_rbmc.md`, `27_relion_interop.md` |
| [Tutorial: Patch Motion and Patch CTF](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/tutorial-patch-motion-and-patch-ctf) | basic motion/CTF preprocessing | `03_preprocessing.md`, `ctf_refinement_and_rbmc.md` |
| [Tutorial: Float16 Support](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/tutorial-float16-support) | Float16 storage/performance questions | `03_preprocessing.md`, `24_disk_and_storage.md`, `version_caveats.md` |
| [Tutorial: Particle Picking Calibration](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/tutorial-particle-picking-calibration) | picking thresholds/calibration are the main issue | `04_picking.md`, `16_tuning_recipes.md` |
| [Tutorial: Blob Picker Tuner](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/tutorial-blob-picker-tuner) | blob picking needs systematic tuning | `04_picking.md`, `16_tuning_recipes.md` |
| [Tutorial: Helical Processing using EMPIAR-10031 (MAVS)](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/case-study-empiar-10031-mavs) | helical reconstruction/filament processing | `11_helical.md`, `19_symmetry.md` |
| [Tutorial: Maximum Box Sizes for Refinement](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/performance-metrics) | box size, memory, speed, or refinement limits | `05_extraction_2d.md`, `07_refinement.md`, `21_gpu_lane_queue.md` |
| [Tutorial: CTF Refinement](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/tutorial-ctf-refinement) | local/global CTF refinement strategy | `ctf_refinement_and_rbmc.md`, `07_refinement.md` |
| [Tutorial: Ewald Sphere Correction](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/tutorial-ewald-sphere-correction) | high-resolution Ewald correction question | `ctf_refinement_and_rbmc.md`, `07_refinement.md` |
| [Tutorial: Symmetry Relaxation](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/tutorial-symmetry-relaxation) | relaxing or validating imposed symmetry | `19_symmetry.md`, `07_refinement.md` |
| [Tutorial: Orientation Diagnostics](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/tutorial-orientation-diagnostics) | preferred-orientation diagnosis | `orientation_and_preferred_views.md`, `10_postprocessing.md` |
| [Tutorial: BILD files](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/tutorial-bild-files) | visualizing orientations/directions with BILD | `orientation_and_preferred_views.md`, `version_caveats.md` |
| [Tutorial: Mask Creation](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/mask-selection-and-generation-in-ucsf-chimera) | local/focused refinement masks, including ChimeraX mask generation | `20_masks.md`, `09_local_refinement.md` |
| [Tutorial: 3D Classification](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/tutorial-3d-classification) | discrete heterogeneity/class separation | `08_classification_3d.md`, `16_tuning_recipes.md` |
| [Tutorial: 3D Variability Analysis (Part One)](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/tutorial-3d-variability-analysis-part-one) | first-pass 3DVA / continuous motion discovery | `26_continuous_heterogeneity.md`, `08_classification_3d.md` |
| [Tutorial: 3D Variability Analysis (Part Two)](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/tutorial-3d-variability-analysis-part-two) | follow-up 3DVA interpretation/use | `26_continuous_heterogeneity.md`, `08_classification_3d.md` |
| [Tutorial: 3D Flexible Refinement](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/tutorial-3d-flexible-refinement) | 3DFlex refinement setup/interpretation | `26_continuous_heterogeneity.md`, `09_local_refinement.md` |
| [Tutorial: 3D Flex Mesh Preparation](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/tutorial-3d-flex-mesh-preparation) | custom mesh preparation for 3DFlex | `26_continuous_heterogeneity.md` |

Additional Guide entries outside the original landing-page list:

| Source | Use when | Load |
|---|---|---|
| [Dynamic Masking in Refinements (v5.0+)](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/tutorial-dynamic-masking-in-refinements-v5.0) | compare refinement masks and resolution/FSC masks across v4/v5 | `20_masks.md`, `10_postprocessing.md` |
| [Symmetry in CryoSPARC](https://guide.cryosparc.com/symmetry-in-cryosparc) | check point-group axes and I1/I2 conventions | `19_symmetry.md` |
| [The FSC and Gold-Standard Refinement](https://guide.cryosparc.com/the-fsc-and-gold-standard-refinement) | half-set independence, masking, noise substitution, global versus local quality | `10_postprocessing.md` |
| [EMPIAR-10291: 300-micrograph walkthrough](https://guide.cryosparc.com/processing-data/tutorials-and-case-studies/case-study-processing-empiar-10291-300-micrographs-to-3.4a-in-1-hour-25-minutes) | older compact exploratory example; timings are historical | `00_overview.md`, `18_decision_trees.md` |
| [CAK, GPCR and practical workflow examples](automated_workflow_tutorials.md) | repeated-target automation, JSON downloads, setup and timing | `automated_workflow_tutorials.md` |
